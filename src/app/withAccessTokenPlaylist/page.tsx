...
const YOUTUBE_PLAYLIST_ITEMS_API = "https://www.googleapis.com/youtube/v3/playlistImages";

const ACCESS_TOKEN = process.env.NEXT_PUBLIC_YOUTUBE_ACCESS_TOKEN;
...
export default function Page() {
  ...
  const fetchPlaylist = async () => {
    ...
    if (!ACCESS_TOKEN) {
      setError('Access token is missing. Please configure it properly.');
      return;
    }
    ...
    try {
      const res = await fetch(
        `${YOUTUBE_PLAYLIST_ITEMS_API}?part=snippet%2CcontentDetails&channelId=${channelId}&maxResults=25`,
        {
          method: 'GET',
          headers: {
